            ...
            {isMenuOpen && (
                <div className="md:hidden absolute top-16 left-0 w-full z-20 bg-white shadow-lg">
                    <div className="flex flex-col items-center p-4">
                        <a className="py-2 hover:underline" href="#comofunciona">Como Funciona</a>
                        <a className="py-2 hover:underline" href="#recompensas">Recompensas</a>
                        <a className="py-2 hover:underline" href="#precos">Preços</a>
                        <a className="py-2 hover:underline" href="#faq">FAQ</a>
