...
export default function Simple() {
    ...
    return (
        <div>
            <div className="w-full py-4 bg-white flex justify-center h-[500px] items-center">
                <div className="w-screen flex max-w-5xl justify-between">
                    ...
                    <div className="z-10 flex flex-col mt-5 w-full gap-4 items-center justify-center">
                        <h1 className="text-3xl font-bold text-green-600">Veja como é Simples</h1>
                        <div className="w-full font-extralight text-center text-lg max-w-[750px] flex flex-col gap-7">
                        ...
                        <div className="flex mt-10 relative items-center justify-center">
                            {/* Bloco 01 */}
                            <div className="text-sm gap-3 font-thin flex items-center justify-center flex-col">
                                <Image
                                    src={edit}
                                    width={110}
                                    quality={100}
                            ...
                            <span className="absolute border-dashed border-black max-w-[550px] w-full h-0.5 border-t-2 mb-24 -z-10"></span>
                        </div>
                    </div>
                </div>
            </div>
